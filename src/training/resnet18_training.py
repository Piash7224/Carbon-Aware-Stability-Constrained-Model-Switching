...
# CHECK YOUR PATH: I used the standard Kaggle Food101 path. Change if yours is different.
...
# A. Define Transforms
# --------------------
# TRAIN: Augmentation (Harder -> Prevents Overfitting)
...
# EVAL (Val/Test): Center Crop (Clean -> Authentic Score)
...
try:
    ...
    # 3. Generate Indices (Seed 42 ensures every model sees exact same images)
...
# Adjusted StepSize to 7 to prevent Underfitting (gives model more time at higher LR)
